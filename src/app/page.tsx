...
const Navigate = ({ handleToggleSearchBox, handleToggleLogin, handleToggleCart }: {
  ...
  return (
    <div className="relative">
      <div className="flex flex-wrap w-auto min-w-20 min-h-20 m-auto mb-130 mt-10 items-center justify-center
      sm:w-full sm:min-w-200:">
        <div className="w-10 flex flex-wrap justify-around items-center gap-20 absolute left-[10%] top-[20%]
        sm:w-auto sm:h-auto sm:relative sm:left-0">
          ...
          ">
            {token || username ? (
              ...
              <button className="w-auto cursor-pointer text-white" onClick={() => { handleToggleLogin(true) }}>
      ...
      <div className="flex w-full justify-center flex-wrap absolute -top-55 z-[-100] ">
...
const LoginForm = ({ setShowLogin, setShowRegister }: {
  ...
  return (<>
    <div className="fixed inset-0 top-60 m-auto min-w-30 h-120  p-4 border bg-black/35 p-5 rounded-md shadow-[0px_4px_6px_rgba(0,0,0,0.2)] backdrop-blur-md
