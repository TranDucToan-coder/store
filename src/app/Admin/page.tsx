...
const Dashboard = () => {
    ...
    return (<div className="w-auto min-w-200 min-h-100 h-auto m-auto mt-10 mb-20 flex flex-wrap gap-10 justify-center">
        <div className="w-110 min-h-10 h-auto border rounded-2xl p6 shadow-2xl">
            <Link href="./Admin/ChangeBanner"><p>Chỉnh ảnh banner</p></Link>
        </div>
