...
const Dashboard = () => {
    ...
    return (
        token ? (
            <div className="w-auto min-w-[80%] min-w-200 min-h-100 h-auto m-auto p-4 mt-10 mb-20 flex flex-wrap gap-10 justify-between
            sm:w-[80%] sm:m-auto sm:mt-10">
                ...
                <div className="w-110 min-h-60 border rounded-2xl p-5 shadow-2xl">
                    ...
                    <Link href="./Admin/ManageCustomer"><p>Danh sách khách hàng</p></Link>
                </div>
                <div className="w-110 min-h-60 border rounded-2xl p-5 shadow-2xl">
                    <p className="text-xl"> Tổng số nhân viên: <label>{dataStaff}</label></p>
                    <Link href="./Admin/ManageEmployee"><p>Danh sách nhân viên</p></Link>
                </div>
            </div>
        ) : (
